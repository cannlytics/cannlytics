...
/// Licensee edit history.
class LicenseeLogs extends ConsumerWidget {
  LicenseeLogs({
    Key? key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return SelectionArea(
      child: FirestoreListView<Map<dynamic, dynamic>?>(
        ...
        query: ref.watch(licenseeLogs([stateId, licenseeId])),
        pageSize: 20,
  ...
  Widget _emptyResults() {
    return SearchPlaceholder(
      title: 'No edits have been made to this licensee.',
      subtitle: 'You can update the licensee data if you are authenticated.',
      imageUrl:
