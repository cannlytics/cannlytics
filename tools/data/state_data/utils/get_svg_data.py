...
directory = r'C:\Users\keega\Documents\cannlytics\cannlytics\console\static\console\images\maps\state-maps'
...
def format_county_data(state, svg_file):
    ...
    d_strings = et_svg_d_strings(doc)
    ids = get_svg_ids(doc)
    doc.unlink()
