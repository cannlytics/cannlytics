...
class LightColors {
  ...
  // Text colors
  static const darkText = Color(0xFF0F0F0F);
...
class DarkColors {
  ...
  static const text = Color(0xFFc6d0f5);
  static const subtext1 = Color(0xFFb5bfe2);
  static const subtext0 = Color(0xFFa5adce);
  static const overlay2 = Color(0xFF949cbb);
  static const overlay1 = Color(0xFF838ba7);
  static const overlay0 = Color(0xFF737994);

  // Surface colors.
  static const Color surface2 = Color(0xFF626880);
  static const Color surface1 = Color(0xFF51576d);
  static const Color surface0 = Color(0xFF414559);
  static const Color base = Color(0xFF303446);
  static const Color mantle = Color(0xFF292c3c);
