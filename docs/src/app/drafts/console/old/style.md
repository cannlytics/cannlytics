...
There is [debate](https://ux.stackexchange.com/questions/124102/should-every-website-have-a-dark-mode) over wether or not a dark theme is necessary. A darker theme can increase computer battery life, reduce energy costs, and may be easier on the eyes. This can be particularly useful for laboratory analysts working at night and labs trying to save costs. Cannlytics strives to provide a default light and dark theme, as well as allow for user's to customize their own theme.
...
SVG formats are preferred. This imposes a IE 9+ / Android 3+ restriction. For programs intended to be run on instrument computers, such as the [Cannlytics Beanstalk](https://cannlytics/beanstalk), icon fonts may be preferrable to ensure browser support for older browsers.
