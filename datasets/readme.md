...
| [`cannabis_results`](https://huggingface.co/datasets/cannlytics/cannabis_tests) | Public cannabis lab test results. |
...
| `cannabis_results/upload_results.py` | Upload cannabis test result data to Firestore. |
