...
Description: This script creates a Bayesian forecast of sales in
New Jersey given all available data.
...
filename = 'D:\\data\\new-jersey\\pdfs\\approved\\1002_GRC NJ LLC_Final FAD Conditional License Approval Letter.pdf'
...
#------------------------------------------------------------------------------
# Future work: Agument with additional public data from the
# Census and Fed FRED.
#------------------------------------------------------------------------------
